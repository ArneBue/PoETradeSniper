...
class ThreadHandlerAPI:
    ...
    def getChangeIDs(self, changeID):
        ...
        return [
            str(int(ids[0]) + 1000) + "-999999999999-999999999999-999999999999-999999999999",
            "999999999999-" + str(int(ids[1]) + 1000) + "-999999999999-999999999999-999999999999",
            "999999999999-999999999999-" + str(int(ids[2]) + 1000) + "-999999999999-999999999999",
            "999999999999-999999999999-999999999999-" + str(int(ids[3]) + 1000) + "-999999999999",
            "999999999999-999999999999-999999999999-999999999999-" + str(int(ids[4]) + 1000)
        ]
