...
class ThreadHandlerAPI:
    ...
    def getChangeIDs(self, changeID):
        ...
        return [
            str(int(ids[0]) + 0000) + "-999999999999-999999999999-999999999999-999999999999",
            "999999999999-" + str(int(ids[1]) + 0000) + "-999999999999-999999999999-999999999999",
            "999999999999-999999999999-" + str(int(ids[2]) + 0000) + "-999999999999-999999999999",
            "999999999999-999999999999-999999999999-" + str(int(ids[3]) + 0000) + "-999999999999",
            "999999999999-999999999999-999999999999-999999999999-" + str(int(ids[4]) + 0000)
        ]
